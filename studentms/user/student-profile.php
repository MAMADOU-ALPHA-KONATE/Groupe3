...
<head>
    ...
    <title>Système de gestion des étudiants || Voir le profil des étudiants</title>
    <!-- plugins:css -->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> Voir le profil des étudiants </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard.php">Tableau de bord</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Voir le profil des étudiants</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <table border="1" class="table table-bordered mg-b-0">
                                        ...
                                        <tr class="table-info">
                                            ...
                                            <th>E-mail étudiant</th>
                                            <td><?php  echo $row->StudentEmail;?></td>
                                        </tr>
                                        <tr class="table-warning">
                                            <th>Classe étudiante</th>
                                        ...
                                        <tr class="table-info">
                                            <th>CV Etudiant</th>
                                            <td><a href="cv.php">Remplir votre CV</a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1;}} ?>
                                    </table>
                                </div>
