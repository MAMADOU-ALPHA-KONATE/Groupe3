...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants || Mot de passe oublié par l'étudiant</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>RÉCUPÉRER MOT DE PASSE</h4>
                <h6 class="font-weight-light">Entrez votre adresse e-mail et votre numéro de téléphone portable pour réinitialiser le mot de passe!</h6>
                <form class="pt-3" id="login" method="post" name="login">
                  ...
                  <div class="mt-3">
                    <button class="btn btn-success btn-block loginbtn" name="submit" type="submit">Réinitialiser</button>
                  </div>
                  <div class="my-2 d-flex justify-content-between align-items-center">
                    
                    <a href="login.php" class="auth-link text-black">se connecter</a>
                  </div>
                  <div class="mb-2">
                    <a href="../index.php" class="btn btn-block btn-facebook auth-form-btn">
                      <i class="icon-social-home mr-2"></i>Retour à l'accueil </a>
                  </div>
