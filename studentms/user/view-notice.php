...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants || Afficher l'avis</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Afficher l'avis </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Tableau de bord</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Afficher l'avis</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
<tr class="table-info">
  ...
  <?php $cnt=$cnt+1;}} else { ?>
<tr>
  <th colspan="2" style="color:red;">Aucun avis trouvé</th>
</tr>
  <?php } ?>
</table>
                  </div>
