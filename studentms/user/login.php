...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants || Page de connexion des étudiants</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" id="login" method="post" name="login">
                  ...
                  <div class="mt-3">
                    <button class="btn btn-success btn-block loginbtn" name="login" type="submit">Se connecter</button>
                  </div>
                  <div class="my-2 d-flex justify-content-between align-items-center">
                    <div class="form-check">
                      <label class="form-check-label text-muted">
                        <input type="checkbox" id="remember" class="form-check-input" name="remember" <?php if(isset($_COOKIE["user_login"])) { ?> checked <?php } ?> /> Gardez-moi connecté </label>
                    </div>
