...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants || Étudiant Changer le mot de passed</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Changer le mot de passe</h4>
                   
                    <form class="forms-sample" name="changepassword" method="post" onsubmit="return checkpass();">
                      
                      <div class="form-group">
                        <label for="exampleInputName1">Mot de passe actuel</label>
                        <input type="password" name="currentpassword" id="currentpassword" class="form-control" required="true">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">nouveau mot de passe</label>
                      ...
                      <button type="submit" class="btn btn-primary mr-2" name="submit">Changement</button>
