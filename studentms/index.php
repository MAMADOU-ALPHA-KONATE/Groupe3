...
<html>
<head>
<title>Système de gestion des étudiants || Page d'accueil</title>
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <h3>Système de gestion des étudiants</h3>      
           <p>Les étudiants inscrits peuvent se connecter ici</p>             
          <div class="readmore">
          <a href="user/login.php">Connexion étudiant<i class="glyphicon glyphicon-menu-right"> </i></a>
          </div>
         </li>
