...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants || Mise à jour À propos de nous</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Mise à jour À propos de nous </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Tableau de bord</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Mise à jour À propos de nous</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Mise à jour À propos de nous</h4>
...
{               ?>      
                      <div class="form-group">
                        <label for="exampleInputName1">Titre de la page:</label>
