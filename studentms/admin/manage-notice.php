...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants|||Gérer l'avis</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title">Gérer l'avis </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Tableau de bord</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Gérer l'avis</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Gérer l'avis</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Voir tout Avis</a>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Titre de l'avis</th>
                            <th class="font-weight-bold">Classe</th>
                            <th class="font-weight-bold">Section</th>
                            <th class="font-weight-bold">Date d'avis</th>
