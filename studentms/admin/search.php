...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants|||Rechercher des étudiants</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Rechercher un étudiant </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Tableau de bord</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Rechercher un étudiant</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <form method="post">
                                ...
                                <button type="submit" class="btn btn-primary" name="search" id="submit">Recherche</button>
                            </form>
