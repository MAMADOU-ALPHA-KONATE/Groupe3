...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants || Ajouter des étudiants</title>
    <!-- plugins:css -->
            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"> Ajouter des étudiants</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Ajouter des étudiants</h4>
