...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants || Profil</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Profil administrateur </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Tableau de bord</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Profil administrateur</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Profil administrateur</h4>
...
{               ?>
                      <div class="form-group">
                        <label for="exampleInputName1">Nom de l'administrateur</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Numéro de contact</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputCity1">Date d'inscription de l'administrateur</label>
