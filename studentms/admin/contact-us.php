...
<html lang="en">
  <head>
    ...
    <title>Système de gestion des étudiants || Contactez-nous</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Contactez-nous </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Contactez-nous</h4>
...
{               ?>    
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Description de la page:</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Numéro de portable:</label>
